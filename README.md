...
Here, I created a synthesised dataset to align with real-world roller coaster characteristics. The data can be found by following the above Github link, under project.ipynb and clicking coasterss.csv
